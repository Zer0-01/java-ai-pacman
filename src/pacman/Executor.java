...
import pacman.controllers.examples.PillsPrioritize;
import pacman.controllers.examples.HoldUntilGhostNear;
import pacman.controllers.examples.PowerPillsThenPills;
import pacman.controllers.examples.RandomGhosts;
import pacman.controllers.examples.RandomNonRevPacMan;
import pacman.controllers.examples.RandomPacMan;
import pacman.controllers.examples.RunFromGhostOnly;
import pacman.controllers.examples.StarterGhosts;
import pacman.controllers.examples.StarterPacMan;
import pacman.controllers.examples.Syara;
import pacman.controllers.examples.Test1;
import pacman.controllers.examples.Test2;
import pacman.controllers.examples.Test3;
import pacman.controllers.examples.Test4;
import pacman.controllers.examples.FleeAndEatRandomly;
import pacman.controllers.examples.PowerpillsPrioritize;
import pacman.controllers.examples.TestValue;
...
{	
	...
	public static void main(String[] args)
	{
		...
		exec.runGame(new HoldUntilGhostNear(), new RandomGhosts(), visual,delay);
//		
...
//		System.out.println("");
//		System.out.println("HOLD UNTIL GHOST NEAR vs LEGACY2THERECONING");
//		exec.runExperiment(new HoldUntilGhostNear(), new Legacy2TheReckoning(),numTrials);
//		System.out.println("");
//		System.out.println("POWERPILLS THEN PILLS vs LEGACY2THERECONING");
//		exec.runExperiment(new PowerPillsThenPills(), new Legacy2TheReckoning(),numTrials);
//		System.out.println("");
//		System.out.println("FLEE AND EAT RANDOMLY vs LEGACY2THERECONING");
//		exec.runExperiment(new FleeAndEatRandomly(), new Legacy2TheReckoning(),numTrials);
//		
//		
...
//		exec.runGameTimed(new StarterPacMan(),new AggressiveGhosts(),visual, delay);
//		exec.runGameTimed(new Syara(), new AggressiveGhosts(),visual, delay);
//		exec.runGameTimed(new Ikhwan(),new AggressiveGhosts(),visual, delay);	

 ...
 */
public class Test1 extends Controller<MOVE>
{	
	...
	{			
		...
		// Strategy 3: Go after the power pills only
		int[] powerPills = game.getPowerPillIndices();

		ArrayList<Integer> targets = new ArrayList<Integer>();

		// Check which power pills are available and add them to targets
		...
		// Return the next direction once the closest power pill has been identified
